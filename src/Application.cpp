...
void Application::createGraphicsPipeline()
{
	...
	auto raychit = ShaderModule(_device, "shaders/closesthit.rchit.spv", VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR);
	...
	if ( vkCreateRayTracingPipelinesKHR(_device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &_raycastPipeline) != VK_SUCCESS) {
